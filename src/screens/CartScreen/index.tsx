...
function index({
  ...
  console.log("aha route params are ",route.params)
  ...
  return (
    ...
    <ScrollView style={{height:height*0.5}}>
      ...
      <ScrollView style={{backgroundColor:'white',height:height*0.385}} showsHorizontalScrollIndicator={false} bounces={true} horizontal={true}>
