...
function MyStack({ navigation, route, cartItems, clearCart}:{navigation:any, route:any, cartItems:{product:Product,quantity:number}[], clearCart:()=> void}) {
...
function HomeNavigator({ navigation, route, cartItems, clearCart}:{navigation:any, route:any,cartItems:Product[],clearCart:() => void}) {
